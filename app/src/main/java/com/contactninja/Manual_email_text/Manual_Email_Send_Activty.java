...
public class Manual_Email_Send_Activty extends AppCompatActivity implements View.OnClickListener, TextClick, TemplateClick, ConnectivityReceiver.ConnectivityReceiverListener, CardClick {
    ...
    private void Listset(List<HastagList.TemplateText> templateTextList) {
        ...
        picUpTextAdepter = new PicUpTextAdepter(Manual_Email_Send_Activty.this, templateTextList, this);
    ...
    void BZCard_list(RecyclerView rv_image_card, BottomSheetDialog bottomSheetDialog, TextClick interfaceClick) throws JSONException {
        ...
        paramObject.addProperty("user_id", signResponseModel.getUser().getId());
        obj.add("data", paramObject);
        retrofitCalls.BZcard_User_list(sessionManager, obj, loadingDialog, token, Global.getVersionname(Manual_Email_Send_Activty.this), Global.Device, new RetrofitCallback() {
            @Override
            public void success(Response<ApiResponse> response) {
                loadingDialog.cancelLoading();
                if (response.body().getHttp_status() == 200) {
                    ...
                    cardListAdepter = new CardListAdepter(Manual_Email_Send_Activty.this, bizcardList,
                            Manual_Email_Send_Activty.this, bottomSheetDialog, interfaceClick);
            ...
            holder.im_file.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (position == 1) {
                        ...
                        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(Manual_Email_Send_Activty.this,
                                R.style.DialogStyle);
                        bottomSheetDialog.setContentView(mView);
    ...
    private void broadcast_manu_zoom(Context mCtx) {
        ...
        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(Manual_Email_Send_Activty.this, R.style.CoffeeDialog);
        bottomSheetDialog.setContentView(mView);
    ...
    void Zoom_create(String starttime, String duration) throws JSONException {
        ...
        obj.add("data", paramObject);
        retrofitCalls.ZoomCreate(sessionManager,obj, loadingDialog, token,Global.getVersionname(Manual_Email_Send_Activty.this),Global.Device, new RetrofitCallback() {
            @Override
            public void success (Response<ApiResponse> response) {
                loadingDialog.cancelLoading();
                if (response.body().getHttp_status() == 200) {
    ...
    public void OpenBob(TextView tv_date) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(Manual_Email_Send_Activty.this,
