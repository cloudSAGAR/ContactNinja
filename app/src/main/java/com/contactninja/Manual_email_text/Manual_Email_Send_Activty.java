...
//
                        ...
                        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(Manual_Email_Send_Activty.this, R.style.DialogStyle);
                        bottomSheetDialog.setContentView(mView);
                        ...
                        cardListAdepter = new CardListAdepter(Manual_Email_Send_Activty.this, broadcast_image_list, iv_selected, Manual_Email_Send_Activty.this, layout_select_image);
                   ...
                   //     Global.Messageshow(Add_Camp_Email_Activity.this,mMainLayout,getResources().getString(R.string.add_contact),false);
                    }
