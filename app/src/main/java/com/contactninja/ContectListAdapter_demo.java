...
public class ContectListAdapter_demo extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ContectListAdapter_demo(@SuppressLint("UnknownNullness") Context context) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)) {
            case ITEM:
                ContectListAdapter_demo.MovieViewHolder holder1 = (ContectListAdapter_demo.MovieViewHolder) holder;
              try {
           ...
           /*       notifyDataSetChanged();*/
            ...
            case LOADING:
                ContectListAdapter_demo.LoadingViewHolder loadingViewHolder = (ContectListAdapter_demo.LoadingViewHolder) holder;
