...
public class RetrofitCalls {
    ...
    public void Analitycs_list(SessionManager session,JsonObject registerinfo, LoadingDialog loadingDialog, String token,String version ,String device_id, RetrofitCallback retrofitCallback) {
        call = retrofitApiInterface.Analitycs_list(RetrofitApiClient.API_Header,token,registerinfo,device_id,version);
        this.retrofitCallback = retrofitCallback;
        this.session = session;
        call_api(retrofitCallback, loadingDialog);
...
/*    public void Contect_List(SessionManager session,JsonObject registerinfo, LoadingDialog loadingDialog, String token,String version ,String device_id, RetrofitCallback retrofitCallback) {
    ...
    public void Upload_csv(SessionManager session,LoadingDialog loadingDialog, String token, RequestBody organization_id,
                           ...
                           String version ,String device_id,RequestBody is_phonebook,RequestBody imei, RetrofitCallback retrofitCallback) {
       call = retrofitApiInterface.Upload_csv(RetrofitApiClient.API_Header,token,import_file,team_id,user_id,organization_id,is_phonebook,imei,device_id,version);
        this.retrofitCallback = retrofitCallback;
        this.session = session;
        call_api(retrofitCallback, loadingDialog);
    ...
    public void Active_Subscription(SessionManager session, JsonObject registerinfo, LoadingDialog loadingDialog, String token, String version , String device_id, RetrofitCallback retrofitCallback) {
        call = retrofitApiInterface.Active_Subscription(RetrofitApiClient.API_Header,token,registerinfo,device_id,version);
        this.retrofitCallback = retrofitCallback;
        this.session = session;
        call_api(retrofitCallback, loadingDialog);
...
*/
    ...
    public void ExposuresList(SessionManager session,JsonObject registerinfo, LoadingDialog loadingDialog, String token,String version ,String device_id, RetrofitCallback retrofitCallback) {
        call = retrofitApiInterface.ExposuresList(RetrofitApiClient.API_Header,token,registerinfo,device_id,version);
        this.retrofitCallback = retrofitCallback;
        this.session = session;
        call_api(retrofitCallback, loadingDialog);
